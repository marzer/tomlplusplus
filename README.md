...
| `TOML_FORMAT_SETPRECISION` | boolean        | `1`                              | When formatting floating point numbers, forces precision to `std::numeric_limits<T>::digits10 + 1`. Set this to 0 if you want to set your own precision with `std::setprecision`. |
